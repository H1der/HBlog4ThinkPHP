<?php /*a:2:{s:70:"G:\wamp64\www\HBlog4ThinkPHP\application/index/view\content\index.html";i:1519826548;s:61:"G:\wamp64\www\HBlog4ThinkPHP\application/index/view\base.html";i:1519825733;}*/ ?>
            ...
            <div class="col-sm-12">
                ...
                <div class="collapse navbar-collapse" id="example-navbar-collapse">
                    <ul class="_menu">
                        ...
                        <li <?php if(input('param.cate_id')==$vo['cate_id']): ?> class="_active" <?php endif; ?>><a href="<?php echo url('index/lists/index',['cate_id'=>$vo['cate_id']]); ?>"><?php echo htmlentities($vo['cate_name']); ?></a>
                        </li>
...
<article>
    <div class="_head">
        <h1><?php echo htmlentities($articleData['arc_title']); ?></h1>
        <span>
								作者：
								<a href=""><?php echo htmlentities($articleData['arc_author']); ?></a>
								</span>
        •
        <!--pubdate表⽰示发布⽇日期-->
    ...
    <div class="_digest">
        <p>
            <?php echo htmlentities($articleData['arc_content']); ?>
        </p>
    </div>
    <div class="_footer">
        <i class="glyphicon glyphicon-tags"></i>
        <?php if(is_array($articleData['tag']) || $articleData['tag'] instanceof \think\Collection || $articleData['tag'] instanceof \think\Paginator): if( count($articleData['tag'])==0 ) : echo "" ;else: foreach($articleData['tag'] as $key=>$vo): ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                ...
                <div class="_single">
                    <p><a href="<?php echo url('index/content/index',['arc_id'=>$vo['arc_id']]); ?>"><?php echo htmlentities($vo['arc_title']); ?></a></p>
            ...
            <div class="col-sm-4">
                ...
                <div id="" class="_single">
                    ...
                    <p><a href="<?php echo htmlentities($vo['link_url']); ?>" target="_blank"><?php echo htmlentities($vo['link_name']); ?></a></p>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
            </div>
        </div>
