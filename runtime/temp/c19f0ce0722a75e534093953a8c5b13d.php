<?php /*a:2:{s:65:"G:\wamp64\www\HBlog4ThinkPHP\application/admin/view\tag\edit.html";i:1518538690;s:61:"G:\wamp64\www\HBlog4ThinkPHP\application/admin/view\base.html";i:1518527101;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="tag_name"
                                       value="<?php echo htmlentities($oldData['tag_name']); ?>">
                            </div>
                        </div>
                    </div>
                </div>
