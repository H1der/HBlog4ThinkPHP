<?php /*a:2:{s:66:"G:\wamp64\www\HBlog4ThinkPHP\application/admin/view\link\edit.html";i:1519309704;s:61:"G:\wamp64\www\HBlog4ThinkPHP\application/admin/view\base.html";i:1519307727;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="link_name" class="form-control" placeholder="请填写友链名称"
                                       value="<?php echo htmlentities($oldData['link_name']); ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="url" name="link_url" class="form-control" placeholder=""
                                       value="<?php echo htmlentities($oldData['link_url']); ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="number" name="link_sort" class="form-control" placeholder=""
                                       value="<?php echo htmlentities($oldData['link_sort']); ?>">
                            </div>
                        </div>
                    </div>
                </div>
